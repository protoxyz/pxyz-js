...
import { PhoneNumber, ResponseStatus } from "@protoxyz/core";
import clsx from "clsx";
import { useEffect, useState } from "react";
import { Button, PhoneInput, VerificationInput } from "../../../inputs";
                        ...
                        <div key={phone.id}>
                            ...
                            {!phone.verifiedAt && (
                                <div className="p-5">
                                    ...
                                    <div className={clsx("mt-1 text-sm text-xs leading-5 text-zinc-600")}>
