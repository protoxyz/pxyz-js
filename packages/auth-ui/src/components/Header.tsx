import { ThemeHeaderAlignment, ThemeHeaderPlacement } from "../types";
...
export function Header({
    ...
    return (
        <div className={clsx(alignmentClasses, placement === ThemeHeaderPlacement.inside ? "mb-10" : "")}>
            {!logo && name && <Heading>{name}</Heading>}
            {logo && <img className="inline-block h-8 w-auto" src={logo} alt={name} />}
