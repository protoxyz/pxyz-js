...
import { apple as Apple } from "../icons/social";
import { windows as Windows, linux as Linux, android as Android } from "../icons/devices";
...
export function UserAgentIcon({ userAgent }: UserAgentIconProps) {
    ...
    return (
        ...
        >
            ...
            {manufacturer === "Apple" && <Apple style={manufacturerStyle} />}
            {manufacturer === "Microsoft" && <Windows style={manufacturerStyle} />}
            {manufacturer === "Linux" && <Linux style={manufacturerStyle} />}
            {manufacturer === "Android" && <Android style={manufacturerStyle} />}
            {manufacturer === "Unknown" && <QuestionMarkCircleIcon style={manufacturerStyle} />}
        </div>
    );
}
