...
import { Theme } from "@protoxyz/core";
...
export function Button({
    ...
    const classes = clsx(className, full ? "w-full" : "w-auto", "flex items-center justify-center");
    ...
    return (
        <button type={type} onClick={loading ? undefined : onClick} className={classes} style={style}>
            {!loading && children}
            {loading && <Spinner size="md" />}
