            ...
            if (item.href) {
                return (
                    <Menu.Item key={item.label}>
                        <Link
                            className={clsx("block px-4 py-4 text-sm", theme?.userDropdownMenuTextColor)}
                            href={item.href}
                        >
                            {item.label}
                        </Link>
            ...
            <div>
                {
                    ...
                    >
                        ...
                        {!children && <ChevronDownIcon className="-mr-1 ml-2 h-5 w-5" aria-hidden="true" />}
                    </Menu.Button>
                }
            </div>
            ...
            >
                ...
                >
                    <div className="flex flex-col items-center justify-center px-5 py-5 text-center">
                        ...
                        <p className="text-sm font-light text-zinc-400 dark:text-zinc-400">Signed in as</p>
                        <p className={clsx("truncate text-sm font-bold", theme?.userDropdownMenuTextColor)}>
                            {primaryEmail || primaryPhone || user.username || "Unknown"}
                        </p>
                    </div>
                    <div className={clsx("divide-y py-1 ", theme?.userDropdownMenuDividerColor)}>
