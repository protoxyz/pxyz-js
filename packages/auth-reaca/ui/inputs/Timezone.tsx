...
import { ITimezoneOption, TimezoneSelectOptions, useTimezoneSelect } from "react-timezone-select";
...
export function NativeSelectTimezone({ selectOptions, className, value, onChange }: NativeSelectTimezoneProps) {
