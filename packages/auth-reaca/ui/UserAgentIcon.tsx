...
export function UserAgentIcon({ userAgent }: UserAgentIconProps) {
    ...
    return (
        ...
        >
            ...
            {manufacturer === "Apple" && <SocialIcons.apple style={manufacturerStyle} />}
            {manufacturer === "Microsoft" && <DeviceIcons.windows style={manufacturerStyle} />}
            {manufacturer === "Linux" && <DeviceIcons.linux style={manufacturerStyle} />}
            {manufacturer === "Android" && <DeviceIcons.android style={manufacturerStyle} />}
