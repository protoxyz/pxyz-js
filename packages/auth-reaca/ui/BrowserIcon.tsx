...
export function BrowserIcon({ userAgent, size = "xs" }: BrowserIconProps) {
    ...
    switch (browser) {
        case "Chrome":
            return <DeviceIcons.googlechrome style={fullStyle} />;
        case "Firefox":
            return <DeviceIcons.firefox style={fullStyle} />;
        case "Safari":
            return <DeviceIcons.safari style={fullStyle} />;
        case "Edge":
            return <DeviceIcons.microsoftedge style={fullStyle} />;
        case "Opera":
