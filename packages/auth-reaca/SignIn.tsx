  ...
  return (
    <IsLoggedOut>
      <div className="mx-auto w-full max-w-md">
        {shouldShowHeader &&
          headerPlacement === ThemeHeaderPlacement.outside &&
          header}
        ...
        <div className="relative mt-8">
          <SignInCard>
            ...
            {signInAttempt &&
              signInAttempt.status === AuthSignInAttemptStatus.complete && (
            ...
            {signInAttempt &&
              signInAttempt.status ===
                AuthSignInAttemptStatus.needs_factor_one &&
              signInAttempt.strategy === AuthVerificationStrategy.oauth && (
                <div className="flex items-center justify-center">
                  <Spinner size="3xl" />
                </div>
            ...
            {(!signInAttempt ||
              ...
              <>
                ...
                <form
                  method="POST"
                  className="space-y-6"
                  onSubmit={onCreateSignInAttempt}
                >
                  <>
                    {instance?.emailSignInEnabled && (
                    ...
                    {instance?.strategy ===
                      AuthenticationStrategy.passwords && (
                      <div className="space-y-1">
                    ...
                    {hasNonSocialSignIn && (
                      <PrimaryButton
                        type="submit"
                        full
                        loading={isCreatingSignInAttempt}
                      >
                        Sign In
                      </PrimaryButton>
                    )}
                ...
                {socialPlacement === ThemeSocialPlacement.bottom &&
                  socialButtons}
              </>
            )}
