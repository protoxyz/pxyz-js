...
export function SecurityTabSessions() {
  ...
  return (
    <div className="col-span-full py-24 md:col-span-2">
      <h2 className="text-xl font-semibold leading-7 text-zinc-400">
        Sessions
      </h2>
      <p className="text-md mt-1 leading-6 text-zinc-300">
        Manage your active sessions and logout of any sessions you don't
        recognize.
      </p>
      {error && <div>{error}</div>}
      <div className="mt-6">
              ...
              <li key={session.id} className="py-4">
                <div className="flex items-center space-x-4">
                  <div className="min-w-0 flex-1">
                    <p className="text-md font-medium leading-6 text-zinc-400">
                      {session.device}
                    </p>
                    <p className="text-md mt-1 leading-6 text-zinc-300">
