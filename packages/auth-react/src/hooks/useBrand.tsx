...
export function useBrandName({ component }: { component: AuthComponentType }) {
    ...
    return appearance?.layout?.brandName ?? instance?.brandingApplicationName ?? "ProtoXYZ";
}
...
export function useBrandLogo({ component }: { component: AuthComponentType }) {
    ...
    return appearance?.layout?.logoImageUrl ?? instance?.brandingApplicationLogoUri ?? null;
}
