                ...
                <AlertDialog>
                    ...
                    <AlertDialogContent>
                        ...
                        <AlertDialogFooter>
                            ...
                            <AlertDialogAction color="red" onClick={() => deleteOrganization({ onDelete })}>
                                Continue
                            </AlertDialogAction>
                        </AlertDialogFooter>
                    </AlertDialogContent>
...
export function OrganizationSettingsRoute({ onDeleteOrganization }: OrganizationSettingsOptions) {
    ...
    return (
        <div className="grid gap-8">
            <SectionHeader title="Settings" description="Manage organization settings" />
...
export function UpdateOrganizationForm({
    ...
    const { organizations, isUpdating, updateOrganization, updateError } = useProtocolAuthOrganizationsList({});
    ...
    async function handleFormSubmit(values: z.infer<typeof UpdateOrganizationFormSchema>) {
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(handleFormSubmit, onInvalid)} className="space-y-8">
                ...
                <div className="flex flex-col gap-1">
                    <Button type="submit" variant="default" className="w-full uppercase" disabled={isUpdating}>
