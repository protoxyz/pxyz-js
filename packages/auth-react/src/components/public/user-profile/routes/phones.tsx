...
export function UserPhonesRoute({}: UserPhonesRouteOptions) {
    ...
    return (
        <div className="grid gap-8">
            <SectionHeader title="Phone Numbers" description="Manage the phone numbers associated with your account." />
                ...
                return (
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            <div className="text-sm font-medium text-gray-900">{phone.phone}</div>
