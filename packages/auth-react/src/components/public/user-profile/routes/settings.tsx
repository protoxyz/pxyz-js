...
import { userDisplayName, userImage, userInitials } from "../../../../lib/display";
...
export function UpdateUserForm({ onCancel, onSubmit, afterUpdateUserRedirectUri }: UpdateUserFormOptions) {
    ...
    async function handleFormSubmit(values: z.infer<typeof UpdateUserFormSchema>) {
        const response = await updateProfile({ ...values });
        if (response.status === ResponseStatus.Success) {
            if (afterUpdateUserRedirectUri) window.location.href = afterUpdateUserRedirectUri;
            onSubmit?.(response);
        }
    }
