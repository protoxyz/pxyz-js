...
export function SecurityRoute({}: SecurityRouteOptions) {
    ...
    return (
        <div className="grid gap-8">
            <SectionHeader title="Password" description="Manage your account password" />
            <SectionHeader title="Two-Factor Authentication" description="Manage your 2fa verification methods" />
        </div>
    );
}
