...
export const PrepareSignUpAttemptVerificationPath =
  '/api/auth/frontend/v0/sign-ups/{id}/prepare-verification';
export const AttemptSignUpAttemptVerificationPath =
