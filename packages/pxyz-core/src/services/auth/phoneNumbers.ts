...
export const DeletePhoneNumberPath =
  '/api/auth/frontend/v0/user/phones/{phoneId}';
export const VerifyPhoneNumberPath =
  '/api/auth/frontend/v0/user/phones/{phoneId}/verify';
export const ResendPhoneNumberVerificationPath =
  '/api/auth/frontend/v0/user/phones/{phoneId}/resend';
export const SetPhoneNumberPrimaryPath =
...
export class ProtocolAuthPhoneNumbersService {
  ...
  ): Promise<CreatePhoneNumber201Response> {
    return this.protocol.client.request<CreatePhoneNumber201Response>(
      'POST',
      CreatePhoneNumberPath,
      options,
    );
  }

  delete(
    options?: DeletePhoneNumberOptions,
  ): Promise<DeletePhoneNumber200Response> {
    return this.protocol.client.request<DeletePhoneNumber200Response>(
      'DELETE',
      DeletePhoneNumberPath,
      options,
    );
  }

  verify(
    options?: VerifyPhoneNumberOptions,
  ): Promise<VerifyPhoneNumber200Response> {
  ...
  setPrimary(
    options?: SetPhoneNumberPrimaryOptions,
  ): Promise<SetPhoneNumberPrimary200Response> {
