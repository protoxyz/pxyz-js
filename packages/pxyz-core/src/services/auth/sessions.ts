...
import {
  EndSessionOptions,
  IssueSessionTokenOptions,
  ListSessionsOptions,
} from '../../requests';
import {
  EndSession200Response,
  IssueSessionToken200Response,
...
export class ProtocolAuthSessionsService {
  ...
  list(options?: ListSessionsOptions): Promise<ListSessions200Response> {
    return this.protocol.client.request<ListSessions200Response>(
      'GET',
      ListSessionsPath,
      options,
    );
  ...
  ): Promise<IssueSessionToken200Response> {
    return this.protocol.client.request<IssueSessionToken200Response>(
      'POST',
      IssueTokenPath,
      options,
    );
