...
export const ListSocialConnectionsPath =
  '/api/auth/frontend/v0/user/connections';
export const CreateSocialConnectionPath =
  '/api/auth/frontend/v0/user/connections';
export const DeleteSocialConnectionPath =
  '/api/auth/frontend/v0/user/connections/{connectionId}';
export const GetSocialConnectionPath =
  '/api/auth/frontend/v0/user/connections/{connectionId}';
export const UpdateSocialConnectionPath =
  '/api/auth/frontend/v0/user/connections/{connectionId}';
...
export class ProtocolAuthSocialConnectionsService {
  ...
  list(
    options?: ListSocialConnectionsOptions,
  ...
  create(
    options?: CreateSocialConnectionsOptions,
  ): Promise<CreateSocialConnection200Response> {
  ...
  delete(
    options?: DeleteSocialConnectionOptions,
  ): Promise<DeleteSocialConnection200Response> {
  ...
  get(
    options?: GetSocialConnectionOptions,
  ): Promise<GetSocialConnection200Response> {
    return this.protocol.client.request<GetSocialConnection200Response>(
      'GET',
      GetSocialConnectionPath,
      options,
    );
  }

  update(
    options?: UpdateSocialConnectionOptions,
  ): Promise<UpdateSocialConnection200Response> {
