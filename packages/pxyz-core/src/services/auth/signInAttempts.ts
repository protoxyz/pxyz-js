...
export const PrepareSignInAttemptFirstFactorPath =
  '/api/auth/frontend/v0/sign-ins/{id}/prepare-first-factor';
export const AttemptSignInAttemptFirstFactorPath =
  '/api/auth/frontend/v0/sign-ins/{id}/attempt-first-factor';
export const PrepareSignInAttemptSecondFactorPath =
  '/api/auth/frontend/v0/sign-ins/{id}/prepare-second-factor';
export const AttemptSignInAttemptSecondFactorPath =
