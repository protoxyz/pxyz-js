...
export const ListOrganizationInvitationsPath = "/api/auth/frontend/v0/organizations/{organizationId}/invitations";
export const GetOrganizationInvitationPath =
    "/api/auth/frontend/v0/organizations/{organizationId}/invitations/{userId}";
export const CreateOrganizationInvitationPath = "/api/auth/frontend/v0/organizations/{organizationId}/invitations";
