...
export const DeleteEmailAddressPath = "/api/auth/frontend/v0/user/emails/{emailId}";
export const VerifyEmailAddressPath = "/api/auth/frontend/v0/user/emails/{emailId}/verify";
export const ResendEmailAddressVerificationPath = "/api/auth/frontend/v0/user/emails/{emailId}/resend";
export const SetEmailAddressPrimaryPath = "/api/auth/frontend/v0/user/emails/{emailId}/primary";
...
export class ProtocolAuthEmailAddresssService {
    ...
    list(options?: ListEmailAddressesOptions): Promise<ListEmailAddresses200Response> {
        return this.protocol.client.request<ListEmailAddresses200Response>("GET", ListEmailAddressesPath, options);
    }

    create(options?: CreateEmailAddressOptions): Promise<CreateEmailAddress201Response> {
        return this.protocol.client.request<CreateEmailAddress201Response>("POST", CreateEmailAddressPath, options);
    }

    delete(options?: DeleteEmailAddressOptions): Promise<DeleteEmailAddress200Response> {
        return this.protocol.client.request<DeleteEmailAddress200Response>("DELETE", DeleteEmailAddressPath, options);
    }

    verify(options?: VerifyEmailAddressOptions): Promise<VerifyEmailAddress200Response> {
        return this.protocol.client.request<VerifyEmailAddress200Response>("POST", VerifyEmailAddressPath, options);
    }
