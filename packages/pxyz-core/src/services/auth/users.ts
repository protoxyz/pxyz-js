...
export class ProtocolAuthUsersService {
    ...
    profile(options?: GetUserProfileOptions): Promise<GetUserProfile200Response> {
        return this.protocol.client.request<GetUserProfile200Response>("GET", GetUserProfilePath, options);
    }

    updateProfile(options?: UpdateUserProfileOptions): Promise<GetUserProfile200Response> {
        return this.protocol.client.request<GetUserProfile200Response>("PUT", UpdateUserProfilePath, options);
    }

    delete(options?: DeleteUserOptions): Promise<DeleteUser200Response> {
        return this.protocol.client.request<DeleteUser200Response>("DELETE", DeleteUserPath, options);
    }
}
