...
export const GetAuthInstanceByDomainPath =
  '/api/auth/frontend/v0/instances/domain/{domain}';
export const GetAuthInstanceByIdPath =
  '/api/auth/frontend/v0/instances/id/{id}';
export const GetAuthInstanceByPublicKeyPath =
...
export class ProtocolAuthInstancesService {
  ...
  getByPublicKey(
    options?: GetAuthInstanceByPublicKeyOptions,
  ): Promise<GetAuthInstance200Response> {
    return this.protocol.client.request<GetAuthInstance200Response>(
      'GET',
      GetAuthInstanceByPublicKeyPath,
      options,
    );
  }

  getById(
    options?: GetAuthInstanceByIdOptions,
  ): Promise<GetAuthInstance200Response> {
    return this.protocol.client.request<GetAuthInstance200Response>(
      'GET',
      GetAuthInstanceByIdPath,
      options,
    );
  }

  getByDomain(
    options?: GetAuthInstanceByDomainOptions,
  ): Promise<GetAuthInstance200Response> {
    return this.protocol.client.request<GetAuthInstance200Response>(
      'GET',
      GetAuthInstanceByDomainPath,
      options,
    );
  }
}
