...
export const ListOrganizationRolesPath = "/api/auth/frontend/v0/organizations/{organizationId}/roles";
export const GetOrganizationRolePath = "/api/auth/frontend/v0/organizations/{organizationId}/roles/{userId}";
export const CreateOrganizationRolePath = "/api/auth/frontend/v0/organizations/{organizationId}/roles";
export const UpdateOrganizationRolePath = "/api/auth/frontend/v0/organizations/{organizationId}/roles/{userId}";
export const DeleteOrganizationRolePath = "/api/auth/frontend/v0/organizations/{organizationId}/roles/{userId}";
...
export class ProtocolAuthOrganizationRolesService {
    ...
    get(options: GetOrganizationRoleOptions): Promise<GetOrganizationRole200Response> {
        return this.protocol.client.request<GetOrganizationRole200Response>("GET", GetOrganizationRolePath, options);
    }
