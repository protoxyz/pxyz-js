...
export const GetWellKnownJWKSPath = "/api/auth/frontend/v0/.well-known/jwks/{domain}";
export const GetWellKnownOpenIDConfigurationPath = "/api/auth/frontend/v0/.well-known/openid-configuration/{domain}";
...
export class ProtocolAuthWellKnownsService {
    ...
    jwks(options?: GetWellKnownJWKSOptions): Promise<GetWellKnownJWKS200Response> {
        return this.protocol.client.request<GetWellKnownJWKS200Response>("GET", GetWellKnownJWKSPath, options);
    }
