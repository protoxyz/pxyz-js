...
// //   '/sign-ins': {
// //     post: (
// //       input: CreateSignInAttemptOptions,
// //     ) => Promise<CreateSignInAttempt201Response>;
// //   };
// //   '/sign-ins/{id}': {
// //     get: (
// //       input: GetSignInAttemptOptions,
// //     ) => Promise<GetSignInAttempt200Response>;
// //     patch: (
// //       input: UpdateSignInAttemptOptions,
// //     ) => Promise<UpdateSignInAttempt200Response>;
// //   };
// //   '/sign-ins/{id}/prepare-first-factor': {
// //     post: (
// //       input: PrepareSignInAttemptFirstFactorOptions,
// //     ) => Promise<PrepareSignInAttemptFirstFactor200Response>;
// //   };
// //   '/sign-ins/{id}/attempt-first-factor': {
// //     post: (
// //       input: AttemptSignInAttemptFirstFactorOptions,
// //     ) => Promise<AttemptSignInAttemptFirstFactor200Response>;
// //   };
// //   '/sign-ins/{id}/prepare-second-factor': {
// //     post: (
// //       input: PrepareSignInAttemptSecondFactorOptions,
// //     ) => Promise<PrepareSignInAttemptSecondFactor200Response>;
// //   };
// //   '/sign-ins/{id}/attempt-second-factor': {
// //     post: (
// //       input: AttemptSignInAttemptSecondFactorOptions,
// //     ) => Promise<AttemptSignInAttemptSecondFactor200Response>;
// //   };
// //   '/sign-ups/': {
// //     post: (
// //       input: CreateSignUpAttemptOptions,
// //     ) => Promise<CreateSignUpAttempt201Response>;
// //   };
// //   '/sign-ups/{id}': {
// //     get: (
// //       input: GetSignUpAttemptOptions,
// //     ) => Promise<GetSignUpAttempt200Response>;
// //     update: (
// //       input: UpdateSignUpAttemptOptions,
// //     ) => Promise<UpdateSignUpAttempt200Response>;
// //   };
// //   '/sign-ups/{id}/prepare-verification': {
// //     post: (
// //       input: PrepareSignUpAttemptVerificationOptions,
// //     ) => Promise<PrepareSignUpAttemptVerification200Response>;
// //   };
// //   '/sign-ups/{id}/attempt-verification': {
// //     post: (
// //       input: AttemptSignUpAttemptVerificationOptions,
// //     ) => Promise<AttemptSignUpAttemptVerification200Response>;
// //   };
// //   '/user/phone-numbers': {
// //     get: (
// //       input: ListPhoneNumbersOptions,
// //     ) => Promise<ListPhoneNumbers200Response>;
// //   };
// //   '/user/emails': {
// //     get: (
// //       input: ListEmailAddressesOptions,
// //     ) => Promise<ListEmailAddresses200Response>;
// //   };
// //   '/user/connections': {
// //     get: (
// //       input: ListConnectionsOptions,
// //     ) => Promise<ListSocialConnections200Response>;
// //   };
// //   '/user/sessions': {
