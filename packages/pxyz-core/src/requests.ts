...
export interface PrepareSignInAttemptSecondFactorOptions extends RequestOptions {
    path: {
        id: string;
    };
    body: {
...
export interface AttemptSignInAttemptSecondFactorOptions extends RequestOptions {
    path: {
        id: string;
    };
    body: {
...
export interface PrepareSignUpAttemptVerificationOptions extends RequestOptions {
    path: {
        id: string;
    };
    body: {
...
export interface AttemptSignUpAttemptVerificationOptions extends RequestOptions {
    path: {
        id: string;
    };
    body: {
